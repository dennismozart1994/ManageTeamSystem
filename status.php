...
<html lang="en">
  <head>
    ...
    <title>InProject - Status do Projeto</title>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i>Status do Projeto</h3>
          	<div class="row mt">
			  		<div class="col-lg-12">
                      <div class="content-panel">
						<!-- Todo Add new event -->
						<a data-toggle="modal" class="btn btn-success btn-sm pull-left" href="lp.php#addLider">Adicionar status</a>
						<!-- End Todo -->
                      <br/><br/><h4><i class="fa fa-angle-right"></i>Filtros</h4>
						<!-- Todo Apply Filter -->
						<form class="form-inline" role="form" action="?filter">
                          <div class="form-group">
                              <label class="sr-only" for="projectname">Status</label>
                              <input type="email" class="form-control" id="projectname" placeholder="Status do projeto">
                          </div>
			  ...
			  <div class="modal-dialog">
				  <div class="modal-content">
					  <div class="modal-header">
						  ...
						  <h4 class="modal-title">Tem certeza que deseja excluir essa status?</h4>
					  </div>
		  ...
		  <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="editar" class="modal fade">
			  <div class="modal-dialog">
				  <div class="modal-content">
					  ...
					  <div class="modal-body">
						<p>status</p>
						<input class="form-control" type="email" value="Em andamento"/>
						<p><br/>Descrição</p>
		  ...
		  <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="addLider" class="modal fade">
			  <div class="modal-dialog">
				  <div class="modal-content">
					  ...
					  <div class="modal-body">
						<p>status</p>
						<input class="form-control" type="email" placeholder="Nome da status"/>
						<p><br/>Descrição</p>
