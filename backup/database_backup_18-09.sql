...
--
-- Host: 127.0.0.1
-- Generation Time: 18-Set-2017 às 22:56
...
INSERT INTO `tab_lider_cliente` (`id_lc`, `id_clt`, `nome_lc`, `email_lc`, `id_user`) VALUES
(1, 1, 'Marcelo Casseb', 'teste@userede.com.br', 1);
...
INSERT INTO `tab_lider_projeto` (`id_lp`, `id_clt`, `nome_lp`, `email_lp`, `id_user`) VALUES
(1, 1, 'Guilherme Ayusso', 'teste@userede.com.br', 1),
(2, 1, 'Guilherme Augustus Cruz Garcia', 'teste@userede.com.br', 1),
(3, 2, 'Nome Teste', 'teste@teste.com', 1);
