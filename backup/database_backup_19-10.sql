...
--
-- Host: 127.0.0.1
-- Generation Time: 19-Out-2017 às 07:00
...
(1, '2017-09-18', 1, '10%', '100%', 'teste', 1, 1),
(2, '2017-09-19', 2, '100%', '100%', 'testando descrição de cenários', 1, 1),
(3, '2017-09-20', 2, '50%', '70%', 'teste de outro usuário interagindo', 1, 4);
...
(1, 1, 'Marcelo Casseb', 'teste@userede.com.br', 1, 0);
...
(1, 1, 'Guilherme Ayusso', 'teste@userede.com.br', 1, 0),
(2, 1, 'Guilherme Augustus Cruz Garcia', 'teste@userede.com.br', 1, 0),
(3, 2, 'Nome Teste', 'teste@teste.com', 1, 0);
...
(1, '999.999', 'Projeto Teste', 1, 1, 1, 1, 1, 1, 1, 5, 1, 1, 1, 1, 0),
...
(1, 1, 'Dennis Mozart', 'Analista de Testes Jr.', 986786566, 'densilva@inmetrics.com.br', 'teste123', 'a61da55239c48ad3dd2830e90c270818.jpg', 0),
(4, 1, 'Rafael Alexandrino', 'Líder de Testes', 988887777, 'rafsouza@inmetrics.com.br', 'teste123', '707cc135c8e0b6fbb65e10b79a6c62f6.jpg', 0),
(5, 1, 'Victor dos Santos', 'Analista de Testes Jr.', 988877788, 'victorsa@inmetrics.com.br', 'teste', 'fcb9a14231c4e9cb5a993120b56ef051.jpg', 0),
(6, 1, 'Neide Licia', 'Auxiliar de Testes', 99999999, 'neide@inmetrics.com.br', 'teste123', 'dcbfad760a11f0d96e3651777e82ff09.jpg', 0);
...
--
ALTER TABLE `tab_historico`
  MODIFY `id_hst` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `tab_lider_cliente`
--
ALTER TABLE `tab_lider_cliente`
  MODIFY `id_lc` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
