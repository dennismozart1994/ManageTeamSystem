                      ...
                      <br/><br/><h4><i class="fa fa-angle-right"></i>Filtros</h4>
						...
						<form class="form-inline" role="form" action="?filter">
                          <div class="form-group">
                              ...
                              <input type="email" class="form-control" id="projectname" placeholder="Motivo da pendência">
                          </div>
						...
						<br/>
                          <section id="unseen">
                            <table class="table table-bordered table-striped table-condensed">
                              ...
                              <tr>
								  <td>999.999</td>
                                  <td>Resposta de dúvidas Rede</td>
								  <td>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi at metus nibh.</td>
		  ...
		  <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="addLider" class="modal fade">
			  <div class="modal-dialog">
				  <div class="modal-content">
					  ...
					  <div class="modal-body">
						<p>Parâmetro</p>
						<input class="form-control" type="email" placeholder="Nome do parâmetro"/>
						<p><br/>Descrição</p>
